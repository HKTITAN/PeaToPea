...
- [x] **6.2** Malicious peer handling
  ...
  - [x] 6.2.2 Document behavior: isolate after N failures (configurable) (Note: `DEFAULT_MAX_INTEGRITY_FAILURES = 3`)

## 7. Failure recovery

- [x] **7.1** Timeouts
  - [x] 7.1.1 Define timeout for chunk request (e.g. 30s); configurable (Note: `DEFAULT_CHUNK_TIMEOUT_TICKS = 30`)
