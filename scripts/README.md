...
**C header (iOS/macOS):** Not a script — from repo root run `cbindgen pea-core -o pea_core.h` (pea-core has `cbindgen.toml`). See [docs/API.md](../docs/API.md). CI generates and verifies the header.
