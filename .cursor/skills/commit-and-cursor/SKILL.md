...
2. **Stage and commit** with a clear, present-tense message. Examples: "Add chunk state tracking in pea-core", "Add rule for platform-impl workflow", "Implement scheduler reassignment on peer leave". Prefer one logical change per commit.
